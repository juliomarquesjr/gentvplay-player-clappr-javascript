var playerElement = document.getElementById("playerCanaldeProdutos");
...
var player = new Clappr.Player({
  ...
  poster: "https://i.ibb.co/rsgKKxM/pexels-pixabay-35550.jpg",
  plugins: [ChromecastPlugin],
  parentId: ".playerCanaldeProdutos",
  autoPlay: true,
  mute: true,
  width: "100%",
  height: "100%",
